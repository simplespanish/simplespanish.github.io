...
<!-- Download Button -->
<a class="btn btn-warning btn-large center-block" href="{{ site.baseurl}}/docs/Trivia.pdf" download="trivial.pdf">Download SimpleSpanish Trivia</a>
<br>
	...
	<div class="panel-body">
		<ol>
			...
			<li>
				...
				<br>
				<img src="{{ site.baseurl}}/images/Clock1.png" height="80px">
				<i class="translation">Es la una y cuarto.</i>
				<img src="{{ site.baseurl}}/images/Clock2.png" height="80px">
				<i class="translation">Son las dos en punto.</i>
				<img src="{{ site.baseurl}}/images/Clock3.png" height="80px">
				<i class="translation">Son las tres menos cuarto.</i>
				<img src="{{ site.baseurl}}/images/Clock4.png" height="80px">
...
<div id="grammar-panel" class="panel panel-default translations-hidden">
	...
	<div class="panel-body">
		<ol>
			...
			<li>
				<strong>¿En qué año Cristóbal Colón descubrió América?</strong>
				<i class="translation">Respuesta: En mil cuatrocientos noventa y dos.</i>
			</li>
			<br>
			<li>
				<strong>¿Cuántas regiones tiene el territorio español?</strong>
				<br>
				<ol>
					<li>12</li>
					<li>17</li>
			...
			<li>
				...
				<br>
				<img src="{{ site.baseurl}}/images/CuadroPicasso.png" height="160px">
				<ul>
					<li>Picasso</li>
					<li>Dalí</li>
					<li>Miró</li>
		...
		<ol>
			...
			<li>
				...
				<ul>
					...
					<li>
						Si yo __________ tú, descansaría después de comer.
